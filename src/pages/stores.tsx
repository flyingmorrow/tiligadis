...
export default function LayoutAuthenticated({ children }: Props) {
  ...
  const handleShow2 = (store: any) => {
    setFormData2({
      westCode: store.westCode,
      street: store.street,
      customerId: store.customerId,
      ConcessionaireName: store.ConcessionaireName,
      city: store.city,
      region: store.region,
      PC: store.PC,
      chain: store.chain,
    ...
    <div className={`${darkMode ? 'dark' : ''}  bg-white overflow-hidden lg:overflow-visible`}>
            ...
            <div className="flex flex-wrap gap-4 justify-between items-center ml-2 mr-6 mb-6">
              <div className="flex  flex-wrap pt-4 gap-4 items-center">
                ...
                <div className="">
                  ...
                  <input
                    onChange={(e) => setFilterData({ ...filters, westCode: e.target.value })}
                    style={{ width: '12rem', marginTop: '-2rem' }}
                    className="w-full bg-gray-100 border-2 border-gray-200 p-2 rounded-lg focus:outline-none focus:bg-white focus:border-blue-500"
                    type="text"
                    id="westCode"
                ...
                <div className="">
                  <button
                    onClick={filter}
                    className=" w-auto text-white font-md py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                    type="button"
                    style={{ background: '#2ec5e3', fontWeight: '600', marginTop: '1.5rem' }}
                  >
                    Apply Filters
                  </button>
                </div>
              ...
              <Button
                onClick={handleShow}
                className="btn sm:w-100  text-white font-medium"
                style={{ background: '#28419a', height: '2.5rem' }}
              >
                Add New Store
              </Button>
            </div>
          ...
          <Table striped className="border rounded shadow-sm" responsive hover size="md">
            <thead>
              <tr className=" border" style={{ fontSize: '14px', fontWeight: 'bold' }}>
                ...
                <th className=" border">Concessionaire Name</th>
                <th className=" border ">Street</th>
                <th className=" border">City</th>
                <th className=" border">Region</th>
                <th className=" border">PC</th>
                <th className=" border">Chain</th>
                <th className="border "></th>
              </tr>
            </thead>
            <tbody>
              {Object.entries(searchedStores).length > 0 &&
                Object.entries(searchedStores).map(([key, value]: any) => {
                  return (
                    <tr key={value.id} style={{ fontSize: '12px' }}>
                      <td className="border ">{value.WEST_Codes}</td>
                      <td className="border ">{value.Customer_Name}</td>
                      <td className="border ">{value.Concessionaire_Name}</td>
                      <td className="border ">{value.Street}</td>
                      <td className="border ">{value.City}</td>
                      <td className="border ">{value.Region_Details}</td>
                      <td className="border ">{value.PC}</td>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <h3 className="font-sm" style={{ color: '#2ec5e3', fontSize: '18px' }}>
            Add New Store
          </h3>
        </Modal.Header>
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mt-0">
              <Form.Control
                type="text"
                placeholder="Enter West Code"
                value={formData.WEST_Codes}
                onChange={(e) => {
                  setFormData({ ...formData, WEST_Codes: e.target.value })
                }}
                required
              />
            </Form.Group>
            ...
            {/* from here add new features.  handsome112 start */}
            <Form.Group className="mt-4">
              <Form.Control
                type="text"
                placeholder="Enter Concessionaire Name"
                value={formData.Concessionaire_Name}
                onChange={(e) => {
                  setFormData({ ...formData, Concessionaire_Name: e.target.value })
                }}
                required
              />
            </Form.Group>
            {/* from here add new features.  handsome112 end */}
            <Form.Group className="mt-4">
              <Form.Control
            ...
            <Form.Group className="mt-4">
              <Form.Control
                ...
                value={formData.Region_Details}
                onChange={(e) => {
                  setFormData({ ...formData, Region_Details: e.target.value })
                }}
                required
              />
            </Form.Group>
            ...
            <Form.Group className="mt-4">
              <Form.Control
                ...
                value={formData.PC}
                onChange={(e) => {
                  setFormData({ ...formData, PC: e.target.value })
                }}
                required
              />
            </Form.Group>
            ...
            <div className="flex flex-wrap justify-start  mt-4">
              <div className="flex gap-4">
                <Button
                  style={{ background: '#2ec5e3', border: 'none', height: '2.5rem', width: '7rem' }}
                  type="submit"
                >
                  Add Store
                </Button>
          ...
          <Form onSubmit={updateStore}>
            <Form.Group className="mt-0">
              <Form.Control
                type="text"
                placeholder="Enter West Code"
                value={formData2.westCode}
                onChange={(e) => {
                  setFormData2({ ...formData2, westCode: e.target.value })
                }}
                required
              />
            </Form.Group>
            <Form.Group className="mt-4">
              <Form.Control
                type="text"
                placeholder="Enter Customer Id"
                value={formData2.customerId}
                onChange={(e) => {
                  setFormData2({ ...formData2, customerId: e.target.value })
                }}
                required
              />
            </Form.Group>
            ...
            <Form.Group className="mt-4">
              <Form.Control
                type="text"
                placeholder="Enter Concessionaire Name"
                value={formData2.ConcessionaireName}
                onChange={(e) => {
                  setFormData2({ ...formData2, ConcessionaireName: e.target.value })
                }}
                required
              />
            </Form.Group>
            ...
            <Form.Group className="mt-4">
              <Form.Control
                ...
                onChange={(e) => {
                  setFormData2({ ...formData2, street: e.target.value })
                }}
                placeholder="Enter Street"
                required
              />
            ...
            <Form.Group className="mt-4">
              <Form.Control
                ...
                onChange={(e) => {
                  setFormData2({ ...formData2, city: e.target.value })
                }}
                required
              />
            </Form.Group>
            ...
            <Form.Group className="mt-4">
              <Form.Control
                type="text"
                placeholder="Enter Region"
                value={formData2.region}
                onChange={(e) => {
                  setFormData2({ ...formData2, region: e.target.value })
                }}
                required
              />
            </Form.Group>
            <Form.Group className="mt-4">
              <Form.Control
                ...
                value={formData2.PC}
                onChange={(e) => {
                  setFormData2({ ...formData2, PC: e.target.value })
                }}
                required
              />
            </Form.Group>
            ...
            <Form.Group className="mt-4">
              <Form.Control
                ...
                onChange={(e) => {
                  setFormData2({ ...formData2, chain: e.target.value })
                }}
                required
              />
            </Form.Group>
